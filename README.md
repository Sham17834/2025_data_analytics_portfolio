...
[![Power BI](https://img.shields.io/badge/PowerBI-Dashboard-orange?logo=powerbi)](https://powerbi.microsoft.com/)
[![Tableau](https://img.shields.io/badge/Tableau-Dashboard-blueviolet?logo=tableau)](https://www.tableau.com/)
[![SQL](https://img.shields.io/badge/SQL-Data%20Querying-success?logo=postgresql)](https://www.mysql.com/)
[![Excel](https://img.shields.io/badge/Excel-Analytics-green?logo=microsoft-excel)](https://www.microsoft.com/en-us/microsoft-365/excel)
...
- `1950 to 2025 Movie Dashboard.twb`  
...
- `Survey Professional Dashboard.pbix`  
- `practice.pbix`  
...
- `main.ipynb`  
- `mentalhealth_dataset_cleaned.csv`  
- `usa_oilandgas_production.csv`  
...
- `Shopee_Dashboard_page-0001.jpg`  
- `20240121_shopee_sample_data.csv`  
- `shopee_sales.sql`  

**Description:**  
A full data analytics workflow for **Shopee’s e-commerce dataset**, integrating data extraction, cleaning, and visualization.

**Workflow:**
1. **SQL:** Sales data extraction and transformation.  
